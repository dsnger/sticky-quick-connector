    ...
    if (function_exists('acf_add_local_field_group')) {
      acf_add_local_field_group([
        ...
        'fields' => [
          ...
          [
            'key' => 'field_67b21c4884e6c',
            'label' => 'Breakpoint',
            'type' => 'number',
            'instructions' => 'Breakpoint in Pixel.',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
              'width' => '',
          ...
          [
            'key' => 'field_67b21afc351a2',
            'label' => 'Horizontale Position',
            'name' => 'sqc_position_x_alignment_dtp',
            'type' => 'select',
            'instructions' => 'Wähle die horizontale Position des Buttons auf der Seite.',
            'choices' => [
              'left' => 'Links',
          ...
          [
            'key' => 'field_67b21b373ded9',
            'label' => 'Vertikale Position',
            'name' => 'sqc_position_y_alignment_dtp',
            'type' => 'select',
            'instructions' => 'Wähle die vertikale Position des Buttons auf der Seite.',
            'choices' => [
              'top' => 'Oben',
          ...
          [
            'key' => 'field_67b21b449eadf',
            'label' => 'Position X',
            'name' => 'sqc_position_x_dtp',
            'type' => 'number',
            'instructions' => 'Abstand vom Rand in Pixel.',
            'append' => 'px',
            'required' => 0,
          ...
          [
            'key' => 'field_67b21b4f8bc46',
            'label' => 'Position Y',
            'name' => 'sqc_position_y_dtp',
            'type' => 'number',
            'instructions' => 'Abstand vom Rand in Pixel.',
            'append' => 'px',
            'required' => 0,
          ...
          [
            'key' => 'field_67b219178ac71',
            'label' => 'In welchen Seiten anzeigen?',
            'type' => 'accordion',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
