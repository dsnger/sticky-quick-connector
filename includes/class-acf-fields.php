      ...
      acf_add_local_field_group([
        ...
        'fields' => [
          ...
          [
            ...
            'type' => 'select',
            'instructions' => 'Wähle die horizontale Position des Buttons auf der Seite.',
            'choices' => [
              'left' => 'Links',
              'right' => 'Rechts',
            ],
          ...
          [
            ...
            'type' => 'select',
            'instructions' => 'Wähle die vertikale Position des Buttons auf der Seite.',
            'choices' => [
              'top' => 'Oben',
              'center' => 'Mitte',
              'bottom' => 'Unten',
          ...
          array(
            'key' => 'field_679cda770fc4e',
            'label' => 'Spezielle Seitentypen ausschließen',
            'name' => 'sqc_hide_on_special_pages',
            'type' => 'select',
            'instructions' => 'Sonderseitentypen (Blog, Archive, Detailseiten), bei denen der Button nicht angezeigt werden soll.',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
              'width' => '50',
          ...
          array(
            'key' => 'field_679cd988ec1ab',
            'label' => 'Nur bei speziellen Seitentypen zeigen',
            'name' => 'sqc_show_on_special_pages',
            'type' => 'select',
            'instructions' => 'Sonderseitentypen (Blog, Archive, Detailseiten), bei denen der Button explizit angezeigt werden soll.',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
              'width' => '50',
